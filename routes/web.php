...
Route::post('/financeiro', [FinanceiroController::class, 'store']);  // Recebe os dados do formulário
...
Route::post('/usuarios', [UsuarioController::class, 'store']); // Processa os dados recebidos do formulário de cadastro
